...
python evaluate_flow.py --model checkpoints/flow_dsec_raft/final.pth --dataset DSEC_RAFT --dataset_root /home/bhzhang/Documents/code/EventDiffusion/data/RAFT_flow_dataset
